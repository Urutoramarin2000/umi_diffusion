...
from diffusion_policy.model.vision.transformer_obs_memory_encoder import TransformerObsMemoryEncoder


class DiffusionTransformerTimmMemoryPolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
            noise_scheduler: DDPMScheduler,
            obs_encoder: TransformerObsMemoryEncoder,
