...
from diffusion_policy.policy.diffusion_transformer_timm_memory_policy import DiffusionTransformerTimmMemoryPolicy
...
# %%
class TrainDiffusionTransformerTimmMemoryWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf):
        ...
        # configure model
        self.model: DiffusionTransformerTimmMemoryPolicy
        self.model = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionTransformerTimmMemoryPolicy = None
...
def main(cfg):
    workspace = TrainDiffusionTransformerTimmMemoryWorkspace(cfg)
    workspace.run()
